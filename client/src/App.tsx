...
// Main Pages (DDC Homepage)
import DDCHome from "./pages/DDCHome";
...
function Router() {
  return (
    <Switch>
      {/* Main Page (DDC Homepage) */}
      <Route path={"/"} component={DDCHome} />
      <Route path={"/driving-courses"} component={DrivingCourses} />
