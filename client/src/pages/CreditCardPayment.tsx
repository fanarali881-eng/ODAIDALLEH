...
export default function CreditCardPayment() {
  ...
  return (
    <PageLayout variant="default">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 mx-auto w-full max-w-md">
        {/* Header */}
        <div className="text-center mb-6">
          <h1 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">الدفع الآمن</h1>
